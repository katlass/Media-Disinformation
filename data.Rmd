...
#Plotting
c11=ggplot(data=c1, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 1") + ylab("Score (1-5)")+theme_minimal() +ggtitle("Attitude Towards Fact Checkers")
c22=ggplot(data=c2, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 197") + ylab("Score (1-5)")+theme_minimal() +ylim(0, 5)
c33=ggplot(data=c3, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 213") + theme_minimal() +ylab("Score (1-5)")
c44=ggplot(data=c4, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 215") + theme_minimal() +ylab("Score (1-5)")

...
aot01_chart=ggplot(na_data, aes(aot01)) +
  geom_histogram(fill = "mediumpurple",stat="count") +             
...
Now we look to investigate whether there were any similarities among these four participants:
```{r}
...
c11=ggplot(data=c1, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 1") + ylab("Score (1-5)")+ggtitle("Attitude Towards Fact Checkers")
c22=ggplot(data=c2, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 2") + ylab("Score (1-5)")+ylim(0, 5)
c33=ggplot(data=c3, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 3") + ylab("Score (1-5)")
c44=ggplot(data=c4, aes(x=variable, y=Count)) + geom_bar(stat="identity",fill = "mediumpurple") + xlab("Participant 4") + ylab("Score (1-5)")
